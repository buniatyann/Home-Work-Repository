...
#include <stdexcept>
#include <cassert>
#include "../Node/Interface/INode.hpp"
...
public:
    ...
    virtual const INode<T>* frontNode() const = 0;
    virtual INode<T>* frontNode() = 0;

    virtual const INode<T>* backNode() const = 0;
    virtual INode<T>* backNode() = 0;
};
